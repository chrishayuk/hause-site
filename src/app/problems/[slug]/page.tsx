...
export default async function ProblemPage({ params }: { params: Promise<{ slug: string }> }) {
	...
	return (
		<main className="problem-chapter system-story">
			...
			<section id="demonstration" className="problem-demonstration" aria-labelledby="demonstration-title"><header><p className="voice-evidence">01 / EXPERIENCE THE DIFFERENCE</p><h2 id="demonstration-title" className="voice-editorial">{resolution}</h2></header><div className="problem-demo-surface"><Demo /></div></section>
			<section className="problem-encounter" aria-labelledby="encounter-title"><div><p className="voice-evidence">02 / HOW YOU MEET IT</p><h2 id="encounter-title" className="voice-editorial">{problem.statement}</h2></div><p className="voice-system">{problem.symptom}</p></section>
