...
export default function sitemap(): MetadataRoute.Sitemap {
	const pages = ["", "/problems", "/ai-native-design-systems", "/how-hause-grew", "/choosing", "/evals/choosing-1", "/evals/routing-1", "/evals/routing-2", "/evals/reading-1", "/evals/reading-2", "/forms", "/statements", "/instruments", "/performances", "/ask", "/use"].map((p) => ({
		url: `${BASE}${p}`,
