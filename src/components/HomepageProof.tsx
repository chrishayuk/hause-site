...
export function HomepageProof() {
	...
	return (
		<section id="selection-proof" className="home-proof" aria-labelledby="home-proof-title">
			<div>
				<p className="voice-evidence">CHOOSING-1</p>
				<h2 id="home-proof-title" className="voice-editorial">Choosing a form</h2>
			...
			<div className="home-proof-context">
				<p className="voice-evidence">Scope of the evaluation</p>
				...
				<Link href="/evals/choosing-1" className="story-link">Read the evaluation</Link>
			</div>
		</section>
	);
}
