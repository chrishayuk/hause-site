...
export function CollectionEncounter() {
  return <section className="collection-encounter section-exhibition" aria-labelledby="collection-encounter-title">
    <header><p className="voice-evidence">Three ways to communicate</p><h2 className="voice-editorial" id="collection-encounter-title">Read, operate, watch.</h2><p className="voice-system">A form changes the relationship between reader and idea. Choose a mode; then enter its collection below.</p></header>
    <ExhibitionChoices id="collection-mode" legend="Choose an encounter" choices={[
      { label: "I / Read", content: <div className="collection-encounter-stage collection-encounter--read"><p className="voice-evidence">STATEMENT / THE IDEA HOLDS STILL</p><Statement text="Not everything should arrive at once." /><p className="voice-system">A sentence the reader can consider at their own pace.</p><a className="story-link" href="#statements">EXPLORE STATEMENTS ↓</a></div> },
