...
Geist Mono remains available for code and measurements. Archivo loads through
`next/font`, including normal and italic styles.

| Role | Family | Size | Treatment |
| --- | --- | --- | --- |
| Homepage title | Archivo | 36–64px | Regular, 1.12 line height, −0.025em tracking |
...
| Form status | Archivo | 12px | Compact, slight tracking |
